...
static void main_NormalErrorId(void);
...
static void main_NormalErrorId(void)
{
  ...
  /* Initialize function 'NormalErrorId' input arguments. */
  ...
  /* Call the entry-point 'NormalErrorId'. */
  ...
  logSqrErr = NormalErrorId(dv0, dv1, dv2, dv3, dv4, dv5);
}
