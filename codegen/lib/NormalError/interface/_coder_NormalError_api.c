  ...
  void NormalError_api(const mxArray *prhs[6], const mxArray *plhs[1])
{
  ...
  logSqrErr = NormalError(*Rtot, *KdMat, *mfiAdjMean, *tnpbsa, *meanPerCond,
    *biCoefMat);
 ...
 * Return Type  : void
 */
void NormalError_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_NormalError_api.c
 *
 * [EOF]
 */
