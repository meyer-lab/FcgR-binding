...
## 
## Makefile     : PDF_rtw.mk
## Generated on : Mon Jun 27 22:02:03 2016
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PDF.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PDF.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/PDF -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=PDF -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/PDF/PDF_rtwutil.c $(START_DIR)/codegen/lib/PDF/PDF_initialize.c $(START_DIR)/codegen/lib/PDF/PDF_terminate.c $(START_DIR)/codegen/lib/PDF/PDF.c $(START_DIR)/codegen/lib/PDF/ErrorAvidityChange.c $(START_DIR)/codegen/lib/PDF/power.c $(START_DIR)/codegen/lib/PDF/StoneSolver.c $(START_DIR)/codegen/lib/PDF/rt_nonfinite.c $(START_DIR)/codegen/lib/PDF/rtGetNaN.c $(START_DIR)/codegen/lib/PDF/rtGetInf.c
...
OBJS = PDF_rtwutil.obj PDF_initialize.obj PDF_terminate.obj PDF.obj ErrorAvidityChange.obj power.obj StoneSolver.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
%.obj : $(START_DIR)/codegen/lib/PDF/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
