 ...
 * File: _coder_NormalErrorCoef2_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL,
  "NormalErrorCoef2", NULL, false, { 2045744189U, 2170104910U, 2743257031U,
    4284093946U }, NULL };
 ...
 * Return Type  : void
 */
void NormalErrorCoef2_api(const mxArray *prhs[7], const mxArray *plhs[1])
{
  real_T (*Rtot)[12];
  real_T (*KdMat)[60];
  ...
  whichR = NormalErrorCoef2(*Rtot, *KdMat, *mfiAdjMean, *tnpbsa, *meanPerCond,
    *biCoefMat, whichR);
...
void NormalErrorCoef2_atexit(void)
{
  ...
  NormalErrorCoef2_xil_terminate();
}
...
/*
 * File trailer for _coder_NormalErrorCoef2_api.c
 *
 * [EOF]
 */
