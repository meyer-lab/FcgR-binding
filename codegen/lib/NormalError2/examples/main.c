...
static void main_NormalError2(void);
...
static void main_NormalError2(void)
{
  ...
  /* Initialize function 'NormalError2' input arguments. */
  ...
  /* Call the entry-point 'NormalError2'. */
  ...
  logSqrErr = NormalError2(dv0, dv1, dv2, dv3, dv4, dv5, argInit_real_T());
}
