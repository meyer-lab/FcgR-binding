 ...
 * File: _coder_NormalError2_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "NormalError2",
 ...
 * Return Type  : void
 */
void NormalError2_api(const mxArray *prhs[7], const mxArray *plhs[1])
{
  real_T (*Rtot)[7];
  real_T (*KdMat)[60];
  ...
  whichR = NormalError2(*Rtot, *KdMat, *mfiAdjMean, *tnpbsa, *meanPerCond,
                        *biCoefMat, whichR);
...
/*
 * File trailer for _coder_NormalError2_api.c
 *
 * [EOF]
 */
