 ...
 * File: _coder_NormalErrorCoef_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL,
  "NormalErrorCoef", NULL, false, { 2045744189U, 2170104910U, 2743257031U,
    4284093946U }, NULL };
 ...
 * Return Type  : void
 */
  void NormalErrorCoef_api(const mxArray *prhs[6], const mxArray *plhs[1])
{
  real_T (*Rtot)[12];
  real_T (*KdMat)[60];
  ...
  logSqrErr = NormalErrorCoef(*Rtot, *KdMat, *mfiAdjMean, *tnpbsa, *meanPerCond,
    *biCoefMat);
...
/*
 * File trailer for _coder_NormalErrorCoef_api.c
 *
 * [EOF]
 */
