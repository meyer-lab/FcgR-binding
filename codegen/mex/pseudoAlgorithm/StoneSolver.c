...
static emlrtRSInfo s_emlrtRSI = { 6, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };

static emlrtRSInfo t_emlrtRSI = { 15, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };

static emlrtRSInfo u_emlrtRSI = { 24, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };

static emlrtRSInfo v_emlrtRSI = { 13, "log10",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\lib\\matlab\\elfun\\log10.m"
};

static emlrtRSInfo w_emlrtRSI = { 21, "colon",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\lib\\matlab\\ops\\colon.m" };

static emlrtRSInfo db_emlrtRSI = { 13, "sum",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\lib\\matlab\\datafun\\sum.m"
};

static emlrtDCInfo cb_emlrtDCI = { 15, 30, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m", 1 };

static emlrtBCInfo yb_emlrtBCI = { 1, 26, 15, 30, "biCoefMat", "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m", 0 };

static emlrtDCInfo db_emlrtDCI = { 15, 34, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m", 1 };

static emlrtBCInfo ac_emlrtBCI = { 1, 26, 15, 34, "biCoefMat", "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m", 0 };

static emlrtECInfo e_emlrtECI = { 2, 15, 20, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };

static emlrtECInfo f_emlrtECI = { 2, 15, 13, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };

static emlrtRTEInfo m_emlrtRTEI = { 19, 15, "sumprod",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\lib\\matlab\\datafun\\private\\sumprod.m"
};

static emlrtRTEInfo n_emlrtRTEI = { 39, 9, "sumprod",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\lib\\matlab\\datafun\\private\\sumprod.m"
};
                   ...
                   real_T Kd, real_T L0, const real_T biCoefMat[676])
{
  ...
  /* -------------------------------------------------------------------------- */
  bVal = Rtot - muDoubleScalarPower(10.0, b) * (1.0 + v * L0 / Kd *
    muDoubleScalarPower(1.0 + Kx * muDoubleScalarPower(10.0, b), v - 1.0));

  /* -------------------------------------------------------------------------- */
  cVal = Rtot - 1.0000000000000001E-20 * (1.0 + v * L0 / Kd *
    muDoubleScalarPower(1.0 + Kx * 1.0000000000000001E-20, v - 1.0));
  ...
  if (bVal * cVal > 0.0) {
    ...
    while ((b - a > 0.0001) || (muDoubleScalarAbs(cVal) > 0.0001)) {
      ...
      /* -------------------------------------------------------------------------- */
      cVal = Rtot - muDoubleScalarPower(10.0, Req) * (1.0 + v * L0 / Kd *
        muDoubleScalarPower(1.0 + Kx * muDoubleScalarPower(10.0, Req), v - 1.0));
      if (cVal * bVal >= 0.0) {
        b = Req;
        bVal = cVal;
      } else {
  ...
  if (Req == 1000.0) {
    ...
    if (1.0 > v) {
      ...
      if (v != (int32_T)muDoubleScalarFloor(v)) {
        emlrtIntegerCheckR2012b(v, &cb_emlrtDCI, sp);
      }

      loop_ub = (int32_T)v;
      if (!((loop_ub >= 1) && (loop_ub <= 26))) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 1, 26, &yb_emlrtBCI, sp);
      }
    }

    if (v != (int32_T)muDoubleScalarFloor(v)) {
      emlrtIntegerCheckR2012b(v, &db_emlrtDCI, sp);
    }

    cdiff = (int32_T)v;
    if (!((cdiff >= 1) && (cdiff <= 26))) {
      emlrtDynamicBoundsCheckR2012b(cdiff, 1, 26, &ac_emlrtBCI, sp);
    }
    ...
    if ((x[0] != y[0]) || (x[1] != y[1])) {
      emlrtSizeEqCheckNDR2012b(&x[0], &y[0], &e_emlrtECI, sp);
    }
    ...
    for (cdiff = 0; cdiff < 2; cdiff++) {
      ...
      iv2[cdiff] = y_size[cdiff];
    }

    if ((b_x[0] != iv2[0]) || (b_x[1] != iv2[1])) {
      emlrtSizeEqCheckNDR2012b(&b_x[0], &iv2[0], &f_emlrtECI, sp);
    }
