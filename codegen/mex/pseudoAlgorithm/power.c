...
static emlrtRSInfo bb_emlrtRSI = { 58, "power",
  "C:\\Program Files\\MATLAB\\R2015b\\toolbox\\eml\\lib\\matlab\\ops\\power.m" };

static emlrtRSInfo cb_emlrtRSI = { 73, "applyScalarFunction",
           ...
           b_size[2], real_T y_data[], int32_T y_size[2])
{
  ...
  if (dimagree(y_size, b_size)) {
    ...
    emlrtErrorWithMessageIdR2012b(&c_st, &o_emlrtRTEI, "MATLAB:dimagree", 0);
  }
