...
MAKEFILE = pseudoAlgorithm_mex.mk

include pseudoAlgorithm_mex.mki


SRC_FILES =  \
	pseudoAlgorithm_data.c \
...
MEX_FILE_NAME_WO_EXT = pseudoAlgorithm_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\pseudoAlgorithm"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\pseudoAlgorithm/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
