 ...
 *
 * pseudoAlgorithm_terminate.h
 *
 * Code generation for function 'pseudoAlgorithm_terminate'
 *
 */

#ifndef __PSEUDOALGORITHM_TERMINATE_H__
#define __PSEUDOALGORITHM_TERMINATE_H__
...
/* End of code generation (pseudoAlgorithm_terminate.h) */
