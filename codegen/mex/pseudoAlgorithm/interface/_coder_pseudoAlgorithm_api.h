...
extern void pseudoAlgorithm_api(const mxArray * const prhs[10], const mxArray
  *plhs[3]);

#endif

/* End of code generation (_coder_pseudoAlgorithm_api.h) */
