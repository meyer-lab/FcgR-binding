 ...
 *
 * pseudoAlgorithm_emxutil.h
 *
 * Code generation for function 'pseudoAlgorithm_emxutil'
 *
 */

#ifndef __PSEUDOALGORITHM_EMXUTIL_H__
#define __PSEUDOALGORITHM_EMXUTIL_H__
...
/* End of code generation (pseudoAlgorithm_emxutil.h) */
