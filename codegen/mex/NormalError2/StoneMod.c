...
static emlrtRSInfo g_emlrtRSI = { 31, "StoneMod",
  "C:\\Users\\mitadm\\Documents\\GitHub\\recepnum2\\recepnum1-e341e5ae190230fa1e37b36ad6975b293cd98acc\\StoneMod.m"
};

static emlrtRSInfo h_emlrtRSI = { 32, "StoneMod",
  "C:\\Users\\mitadm\\Documents\\GitHub\\recepnum2\\recepnum1-e341e5ae190230fa1e37b36ad6975b293cd98acc\\StoneMod.m"
};

static emlrtRSInfo i_emlrtRSI = { 46, "StoneMod",
  "C:\\Users\\mitadm\\Documents\\GitHub\\recepnum2\\recepnum1-e341e5ae190230fa1e37b36ad6975b293cd98acc\\StoneMod.m"
};
...
static emlrtRSInfo p_emlrtRSI = { 9, "sum",
                ...
                logKx, real_T L0, const real_T biCoefMat[900])
{
  ...
  if (1.0 > v) {
    ...
    if (v != (int32_T)muDoubleScalarFloor(v)) {
      emlrtIntegerCheckR2012b(v, &c_emlrtDCI, sp);
    }

    loop_ub = (int32_T)v;
    if (!((loop_ub >= 1) && (loop_ub <= 30))) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 1, 30, &f_emlrtBCI, sp);
    }
  }
  ...
  nm1d2 = (int32_T)v;
  if (!((nm1d2 >= 1) && (nm1d2 <= 30))) {
    emlrtDynamicBoundsCheckR2012b(nm1d2, 1, 30, &e_emlrtBCI, sp);
  }
