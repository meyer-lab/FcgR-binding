 ...
 *
 * _coder_NormalError2_api.c
 *
 * Code generation for function '_coder_NormalError2_api'
 *
 */
...
void NormalError2_api(const mxArray * const prhs[7], const mxArray *plhs[1])
{
  real_T (*Rtot)[7];
  real_T (*KdMat)[60];
  ...
  whichR = NormalError2(&st, *Rtot, *KdMat, *mfiAdjMean, *tnpbsa, *meanPerCond, *
                        biCoefMat, whichR);
...
/* End of code generation (_coder_NormalError2_api.c) */
