...
MAKEFILE = NormalError2_mex.mk

include NormalError2_mex.mki
...
SRC_FILES =  \
	...
	error.c \
	StoneMod.c \
	_coder_NormalError2_info.c \
	_coder_NormalError2_api.c \
	_coder_NormalError2_mex.c

MEX_FILE_NAME_WO_EXT = NormalError2_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\NormalError2"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NormalError2/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
