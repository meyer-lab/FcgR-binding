...
MAKEFILE = NormalErrorCoef_mex.mk

include NormalErrorCoef_mex.mki


SRC_FILES =  \
	NormalErrorCoef_data.c \
	...
	error.c \
	StoneMod.c \
	_coder_NormalErrorCoef_info.c \
	_coder_NormalErrorCoef_api.c \
	_coder_NormalErrorCoef_mex.c

MEX_FILE_NAME_WO_EXT = NormalErrorCoef_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\NormalErrorCoef"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NormalErrorCoef/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
