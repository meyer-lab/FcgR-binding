 ...
 *
 * Code generation for function '_coder_NormalErrorCoef_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[900]
{
  ...
  void NormalErrorCoef_api(const mxArray * const prhs[6], const mxArray *plhs[1])
{
  real_T (*Rtot)[12];
  real_T (*KdMat)[60];
  ...
  logSqrErr = NormalErrorCoef(&st, *Rtot, *KdMat, *mfiAdjMean, *tnpbsa,
...
/* End of code generation (_coder_NormalErrorCoef_api.c) */
