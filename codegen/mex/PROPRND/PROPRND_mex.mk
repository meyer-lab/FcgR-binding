START_DIR = C:\Users\mitadm\DOWNLO~1\RECEPN~1\RECEPN~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016a
MAKEFILE = PROPRND_mex.mk

include PROPRND_mex.mki
...
MEX_FILE_NAME_WO_EXT = PROPRND_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\PROPRND"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\PROPRND/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
