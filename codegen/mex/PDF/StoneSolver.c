...
static emlrtECInfo emlrtECI = { 2, 15, 20, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };

static emlrtECInfo b_emlrtECI = { 2, 15, 13, "StoneSolver",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\StoneSolver.m" };
                   ...
                   real_T Kd, real_T L0, const real_T biCoefMat[676])
{
  ...
  if (Req == 1000.0) {
    ...
    if ((x[0] != y[0]) || (x[1] != y[1])) {
      emlrtSizeEqCheckNDR2012b(&x[0], &y[0], &emlrtECI, sp);
    }
