...
static emlrtRSInfo emlrtRSI = { 15, "NormalErrorId",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\NormalErrorId.m" };

static emlrtRSInfo b_emlrtRSI = { 20, "NormalErrorId",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\NormalErrorId.m" };

static emlrtRSInfo c_emlrtRSI = { 26, "NormalErrorId",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\NormalErrorId.m" };

static emlrtRSInfo n_emlrtRSI = { 35, "NormalErrorId",
  "C:\\Users\\ryan\\Documents\\GitHub\\recepnum1\\NormalErrorId.m" };
...
real_T NormalErrorId(const emlrtStack *sp, const real_T Rtot[7], const real_T
                     ...
                     biCoefMat[900])
{
  ...
  while (j < 2) {
    ...
    while (ixstart < 6) {
      ...
      while (l < 4) {
        st.site = &emlrtRSI;
        MFI = c * StoneMod(&st, Rtot[0], KdMat[ixstart + 6 * l], Rtot[4 + j],
                           Rtot[1], tnpbsa[j], biCoefMat);
        m = 0;
        while (m < 4) {
          st.site = &b_emlrtRSI;
...
/* End of code generation (NormalErrorId.c) */
