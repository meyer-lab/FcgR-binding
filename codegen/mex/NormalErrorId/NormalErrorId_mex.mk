...
MAKEFILE = NormalErrorId_mex.mk

include NormalErrorId_mex.mki


SRC_FILES =  \
	NormalErrorId_data.c \
	...
	_coder_NormalErrorId_api.c \
	_coder_NormalErrorId_mex.c

MEX_FILE_NAME_WO_EXT = NormalErrorId_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\NormalErrorId"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NormalErrorId/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
