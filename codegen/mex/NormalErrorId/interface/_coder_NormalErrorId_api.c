 ...
 *
 * Code generation for function '_coder_NormalErrorId_api'
 *
 */
...
void NormalErrorId_api(const mxArray * const prhs[6], const mxArray *plhs[1])
{
  real_T (*Rtot)[7];
  real_T (*KdMat)[60];
  ...
  logSqrErr = NormalErrorId(&st, *Rtot, *KdMat, *mfiAdjMean, *tnpbsa,
...
/* End of code generation (_coder_NormalErrorId_api.c) */
