...
def PredictionVersusAvidity(ax, Kx):
    ...
    ax[0].set_ylabel(r'Bound Fc$\gamma$RIII-F')
    ax[1].set_ylabel(r'Multimerized Fc$\gamma$RIII-F')
    ax[2].set_ylabel(r'Fc$\gamma$RIII-F Nxlinks')
    ax[3].set_xlabel(r'Bound Fc$\gamma$RIII-F')
    ax[3].set_ylabel(r'Fc$\gamma$RIII-F Nxlinks')
    ax[3].set_ylim(1, 1E4)
    ax[3].set_xlim(1, 1E4)
